    ...
    public static class EmailHelper
    {
        ...
        public static MailMessage CreateEmailMessage(EmailRequest request)
        {
            ...
            try
            {
                ...
                #region Region for Email Alternate Body

                if (request.AlternateBody != null)
                    mailMessage.AlternateViews.Add(request.AlternateBody);
                ...
                #region Region for headers

                if(request.Headers != null)
                mailMessage.Headers.Add(request.Headers);

                #endregion

                #region Region for DeliveryNotification Options

                if(request.DeliveryOptions != null)
                mailMessage.DeliveryNotificationOptions = request.DeliveryOptions; 

                #endregion

                #region Region for Email Attachments
